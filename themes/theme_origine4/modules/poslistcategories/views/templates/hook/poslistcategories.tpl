...
<div class="container">
		<!-- <div class="pos_title"> -->
			<!-- <h2>{l s='Popular Categories' mod='poslistcategories'}</h2> -->
		<!-- </div> -->
					...
					<div class="list-categories">
						{if $category.image}
							...
							<div class="box-content">
								<h2><a href="{$link->getCategoryLink($category['id_category'])}" target="_blank">{$category.category_name}</a></h2>
								<p class="number_product">{$category.nbProducts} {l s='products' mod='poslistcategories'}</p>									
							</div>
							</div>
						{/if}
