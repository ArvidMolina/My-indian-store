...
{	
	...
	if(count_block < number_blocks){
		...
		$('#_desktop_vegamenu .pos-menu-vertical .menu-item').each(function(i,n){
			if(i == number_blocks ) {
				$('.pos-menu-vertical .menu-content').append('<li class="menu-item"><a href="javascript:void(0)" class="view_more"><span><i class="icon-plus"></i>' + MORE + '</span></a></li>'); 
			}
		...
		$('#_desktop_vegamenu .pos-menu-vertical .view_more').click(function() {
			...
			if($(this).hasClass('active')){
				...
				$(this).html('<span><em class="closed-menu"><i class="icon-minus2"></i>'+ CLOSE +'</em></span>');
				$('.hide_menu_block').slideDown();	
			}
			else
			{
				$(this).removeClass('open_menu').addClass('close_menu');
				$(this).html('<span><em class="closed-menu"><i class=" icon-plus"></i>'+ MORE +'</em></span>'); 
