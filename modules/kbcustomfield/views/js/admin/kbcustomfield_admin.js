...
$(document).ready(function() {
    ...
    $('button[name="submitAccount"]').click(function() {
        
    });
    $('input[name="required"]').click(function(event) {
    ...
    $('input[name="show_on_invoice"],input[name="editable"]').click(function(event) {
        alert(feature_not_available);
        event.preventDefault();
        return false;
    });
    ...
    if($('#customer_form').length){
        var config_html = $('.kb_custom_field_block').html();
        $('.kb_custom_field_block').html('');

        var new_html = '<form id="kb_custom_customer_form" enctype="multipart/form-data" method="post" class="defaultForm form-horizontal" action="'+kb_custom_customer_link+'">';
