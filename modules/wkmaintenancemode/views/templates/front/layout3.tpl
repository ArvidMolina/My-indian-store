...
<div class="wraper"
{if $background_image}
style="background: url({$background_image|escape:'html':'UTF-8'}?v={$smarty.now|escape:'html':'UTF-8'}) 0% 0% / 50% 100%;"
{/if}
>
<div class="col-sm-12 col-md-6 col-lg-6 right-container">
  <div class="head-container">
	...
	<div class="share-box">
    	...
    	<a href="{$maintenance.facebook_link|escape:'html':'UTF-8'}" target="_blank" class="facebook" title="Facebook"><img src="{$baseurl|escape:'html':'UTF-8'}modules/wkmaintenancemode/views/img/facebook_blue.png" alt="Facebook"/></a>
        {/if}
        {if $maintenance.twitter_link}
        <a href="{$maintenance.twitter_link|escape:'html':'UTF-8'}" target="_blank" class="twitter" title="Twitter"><img src="{$baseurl|escape:'html':'UTF-8'}modules/wkmaintenancemode/views/img/twitter_blue.png" alt="Twitter"/></a>
        {/if}
        {if $maintenance.googleplus_link}
        <a href="{$maintenance.googleplus_link|escape:'html':'UTF-8'}" target="_blank" class="googleplus" title="Google+"><img src="{$baseurl|escape:'html':'UTF-8'}modules/wkmaintenancemode/views/img/google-plus_blue.png" alt="Google+"/></a>
        {/if}
        {if $maintenance.instagram_link}
        <a href="{$maintenance.instagram_link|escape:'html':'UTF-8'}" target="_blank" class="instagram" title="Instagram">
            <img src="{$baseurl|escape:'html':'UTF-8'}modules/wkmaintenancemode/views/img/instagram_blue.png" alt="Instagram"/>
        </a>
        {/if}
    </div>
    {/if}
