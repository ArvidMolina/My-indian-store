...
$(function(){
    ...
    var x = setInterval(function() {
        cdatetime += 1000;
        var percent = Number(((cdatetime- sdatetime) * 100) / (edatetime - sdatetime)).toFixed(2);
...
function updateCounter(percent)
{
    ...
    $('.countdown__progress').css({'stroke-dashoffset':cir});
    $('#countdown-progress-label-container').css({'transform' : 'rotateZ('+deg+'deg)'});
