...
<div class="checkout_field {if $checkout_field.required}required{/if} {$checkout_field.field_type|escape:'htmlall':'UTF-8'} form-group">
	...
	<input type="checkbox" name="checkout_field[{$checkout_field.id_bestkit_checkout_field|escape:'htmlall':'UTF-8'}]" id="checkout_field_{$checkout_field.id_bestkit_checkout_field|intval}" attr-id="{$checkout_field.id_bestkit_checkout_field|intval}" class="form-control checkout_field_value checkout_field_step_{$checkout_field_step|escape:'htmlall':'UTF-8'}" value="1" {if $yes_lang == $checkout_field.selected_value || $checkout_field.selected_value == 1}checked="checked"{/if}>
