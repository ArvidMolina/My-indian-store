...
class Posslideshows extends Module implements WidgetInterface
{
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1">Happy Summer</p>
					<p class="title2">Vegetable Organic Food 2019</p>
					<p class="title3">Exclusive Offer -20% Off This Week</p>
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
		...
		foreach($slides as &$slide){
			...
			$slide['description'] = str_replace('/pos_optima_kitchen/',__PS_BASE_URI__,$slide['description']);
		}
        if (is_array($slides)) {
            foreach ($slides as &$slide) {
    ...
    public function getAddFieldsValues()
    {
        ...
        $languages = Language::getLanguages(false);
		 ...
		 foreach ($languages as $lang) {
			...
			$fields['description'][$lang['id_lang']] = str_replace('/pos_optima_kitchen/',__PS_BASE_URI__,$fields['description'][$lang['id_lang']]);
		}
