...
define('MP_TOKEN', "1cc65cd2f4dd1a090588323ffc5630f0");
...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The bridge connector module generated for retail.myindianstore.eu! Please, download again bridge connector module and install to the Source shop (old shop) and try connection again.', null);
            return;  
        }
