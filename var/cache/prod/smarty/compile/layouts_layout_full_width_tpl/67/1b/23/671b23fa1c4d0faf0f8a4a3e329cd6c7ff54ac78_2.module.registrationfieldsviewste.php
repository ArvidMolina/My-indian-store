<?php
/* Smarty version 3.1.33, created on 2020-07-14 14:32:19
  from 'module:registrationfieldsviewste' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5f0d97c3a43eb8_08820852',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '671b23fa1c4d0faf0f8a4a3e329cd6c7ff54ac78' => 
    array (
      0 => 'module:registrationfieldsviewste',
      1 => 1591313122,
      2 => 'module',
    ),
  ),
...
function content_5f0d97c3a43eb8_08820852 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_5738852385f0d97c3716206_23958726', "page_content");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, 'page.tpl');
}
/* {block "page_content"} */
class Block_5738852385f0d97c3716206_23958726 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page_content' => 
  array (
    0 => 'Block_5738852385f0d97c3716206_23958726',
  ),
);
...
<?php if (isset($_smarty_tpl->tpl_vars['conf']->value) && $_smarty_tpl->tpl_vars['conf']->value && $_smarty_tpl->tpl_vars['conf']->value == 1) {?>
<div class="alert alert-success success conf">
	<?php if ($_smarty_tpl->tpl_vars['version']->value >= 1.6) {?>
		<button data-dismiss="alert" class="close" type="button">×</button>
	<?php }?>
	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Successful update','mod'=>'registrationfields'),$_smarty_tpl ) );?>

</div>
<?php }?>
<div id="identity" class="box">
	<form id="update_registration_form" class="std" action="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getModuleLink('registrationfields','myinfo'),'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
" name="update_registration" method="POST" enctype="multipart/form-data">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="clearfix form-group margin-form"></div>
				...
				<div class="col-lg-9">
					<?php if ($_smarty_tpl->tpl_vars['version']->value >= 1.6) {?>
						<button id="updateFields" class="btn btn-default button button-medium btn-primary" name="updateFields" type="submit"><span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Save','mod'=>'registrationfields'),$_smarty_tpl ) );?>
<i class="icon-chevron-right right"></i></span></button>
					<?php } else { ?>
						<p class="submit">
							<input id="updateFields" type="submit" value="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Save','mod'=>'registrationfields'),$_smarty_tpl ) );?>
" name="updateFields" class="button btn btn-primary">
						</p>
					<?php }?>
				</div>
			</div>
