...
class __TwigTemplate_6140c3560e73dfeb9f57cf8105c7158527adf4c51446000472817314573d94fb extends \Twig\Template
{
    ...
    <div class=\"col\">
      ...
      ";
        // line 45
        if ( !(isset($context["isHtaccessFileWriter"]) ? $context["isHtaccessFileWriter"] : null)) {
            // line 46
  ...
  ";
    ...
    public function block_language_listing($context, array $blocks = [])
    {
      ...
      <div class=\"col-sm\">
        ";
        // line 56
        $this->loadTemplate("@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "@PrestaShop/Admin/Improve/International/Language/index.html.twig", 56)->display(twig_array_merge($context, ["grid" => (isset($context["languageGrid"]) ? $context["languageGrid"] : null)]));
        // line 57
        echo "      </div>
    </div>
  ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/International/Language/index.html.twig", "/home/myindian/public_html/src/PrestaShopBundle/Resources/views/Admin/Improve/International/Language/index.html.twig");
    }
}
