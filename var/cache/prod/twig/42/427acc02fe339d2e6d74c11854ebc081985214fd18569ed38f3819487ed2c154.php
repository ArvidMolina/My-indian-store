...
class __TwigTemplate_0d694bb9fc890aee6e1bd7f7556d8ef8b983b0029efbf639e4fd4dcbf1b50cba extends \Twig\Template
{
      ...
      <div class=\"card-text\">
        ...
        echo "
          <div class=\"col-sm\">
            ";
        // line 40
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["advancedForm"]) ? $context["advancedForm"] : null), "language_identifier", []), 'errors');
        echo "
            ";
        // line 41
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["advancedForm"]) ? $context["advancedForm"] : null), "language_identifier", []), 'widget');
        echo "
          </div>
        </div>
        ...
        echo "
          <div class=\"col-sm\">
            ";
        // line 48
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["advancedForm"]) ? $context["advancedForm"] : null), "country_identifier", []), 'errors');
        echo "
            ";
        // line 49
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["advancedForm"]) ? $context["advancedForm"] : null), "country_identifier", []), 'widget');
        echo "
          </div>
        </div>
      </div>
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/International/Localization/Blocks/advanced_configuration.html.twig", "/home/myindian/public_html/src/PrestaShopBundle/Resources/views/Admin/Improve/International/Localization/Blocks/advanced_configuration.html.twig");
    }
}
