...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FqodVDStyj', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '3306', 'dbname' => 'myindian_pres577', 'user' => 'myindian_pres577', 'password' => 'sp9k!SV5-1', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d20ac2b7c43315223f81547a3a7c4d2dd027b648994735d18e2b35bede73b529');
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                58 => 'possearchproducts',
                59 => 'productcomments',
                60 => 'blockwishlist',
                61 => 'blocktags',
                62 => 'poslogo',
                63 => 'poslistcategories',
                64 => 'posnewproducts',
                65 => 'poslistcateproduct',
                66 => 'posfeaturedproducts',
                67 => 'postabcateslider',
                68 => 'posmegamenu',
                69 => 'posvegamenu',
                70 => 'posslideshows',
                ...
                81 => 'uecookie',
                82 => 'lgcookieslaw',
                83 => 'ps_cashondelivery',
                84 => 'statscarrier',
                85 => 'ps_wirepayment',
                86 => 'psproductaccess',
                87 => 'ps_emailalerts',
                88 => 'onepagecheckoutps',
                89 => 'watermark',
                90 => 'stregistration',
                91 => 'securitypro',
                92 => 'advancedcustomfields',
                93 => 'leoquicklogin',
                94 => 'updateproducts',
                95 => 'migrationproserver',
            ],
